    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview {{ (Request::segment(2) == 'good' ) ? 'active' : ''  }}">
        ...
        <ul class="treeview-menu">
            <li class="{{ Request::segment(2) == 'good' && Request::segment(3) != 'printDisplay' && Request::segment(3) != 'zeroStock' && Request::segment(3) != 'exp' && Request::segment(3) != 'changeStatus' && Request::segment(3) != 'export' ? 'active' : ''  }}"><a href="{{ url('/' . $role . '/good/all/all/all/20') }}"><i class="fa fa-circle-o"></i> Daftar Barang</a></li>
            ...
            @if($role == 'admin')
              <li class="{{ Request::segment(2) == 'good' && Request::segment(3) == 'export' ? 'active' : ''  }}"><a href="{{ url('/' . $role . '/good/export') }}"><i class="fa fa-circle-o"></i> Export Data Barang</a></li>
              <li class="{{ Request::segment(2) == 'good' && Request::segment(3) == 'zeroStock' ? 'active' : ''  }}"><a href="{{ url('/' . $role . '/good/zeroStock/1/all/all/0/all') }}"><i class="fa fa-circle-o"></i> Daftar Barang Terjual</a></li>
