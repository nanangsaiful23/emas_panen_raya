              ...
              <tbody id="table-good">
                @foreach($distributors as $distributor)
                  <tr>
                    ...
                    <td class="center"><a href="{{ url($role . '/distributor/' . $type . '/' . $distributor->id . '/edit') }}"><i class="fa fa-file orange" aria-hidden="true"></i></a></td>
                    @if($role == 'admin')
                      <td class="center">
                        ...
                        <form id="delete-form-{{$distributor->id}}" action="{{ url($role . '/distributor/' . $type . '/' . $distributor->id . '/delete') }}" method="POST" style="display: none;">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}
                        </form>
                      </td>
