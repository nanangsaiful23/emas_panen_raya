...
<html>
    <head>
        ...
        <link rel="icon" type="image/gif" href="{{asset('assets/icon/TokoPaktani.png')}}" />
                ...
                <div class="col-xs-12">
                  <div class="box">
                    ...
                    <div class="box-body" style="overflow-x:scroll; color: black !important">
                      ...
                      <div class="col-sm-12">
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('anting-anting')">Anting-anting</div>
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('cincin')">Cincin</div>
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('emas murni')">Emas murni</div>
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('gelang')">Gelang</div>
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('kalung')">Kalung</div>
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('liontin')">Liontin</div>
                        <div class="col-sm-2 btn btn-input btn-warning" onclick="changeInput('all')">Seluruh barang</div>
                      </div>
                      <div id="photo-div"> 
                        <?php $i = 1; ?>
                        @foreach($goods as $good)
                          @if($i == 1)
                            <div class="col-sm-12">
                          @endif
                            <div class="col-sm-4" style="text-align: center; border: black solid 2px; height: 400px;"> 
                              ...
                              @foreach($good->good_units as $unit)
                                @if($unit->unit != null)
                                  <h3>{{ showRupiah($unit->selling_price) }}</h3>
                                @else
                                  {{ $unit }}
                                @endif
                              @endforeach
